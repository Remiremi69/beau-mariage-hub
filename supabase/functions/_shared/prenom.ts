// Utilitaires d'affichage des prénoms (Le Cercle) — contexte Deno / Edge Functions.
// ⚠️ Ce fichier est dupliqué à l'identique dans src/lib/prenom.ts (contexte front React).
